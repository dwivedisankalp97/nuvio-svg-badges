...
badge names, regex patterns, colors, and SVG assets stay consistent. The v12 URL
...
```bash
BADGE_BASE_URL="https://raw.githubusercontent.com/<owner>/<repo>/refs/heads/main/dist/v12" node generate-badges.mjs
```
