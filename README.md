...
badge names, regex patterns, colors, and SVG assets stay consistent. The v13 URL
...
```text
dist/v13/preview.html
dist/v13/nuvio-tv-sim-4x.png
dist/preview.html
```
...
```bash
BADGE_BASE_URL="https://raw.githubusercontent.com/<owner>/<repo>/refs/heads/main/dist/v13" node generate-badges.mjs
```
